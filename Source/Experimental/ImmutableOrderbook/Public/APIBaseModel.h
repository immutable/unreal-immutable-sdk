...
struct IMMUTABLEORDERBOOK_API HttpRetryManager
	: public FManager
...
struct IMMUTABLEORDERBOOK_API HttpRetryParams
{
	HttpRetryParams(
...
class IMMUTABLEORDERBOOK_API Model
{
public:
	virtual ~Model() {}
...
class IMMUTABLEORDERBOOK_API Request
{
public:
	virtual ~Request() {}
...
class IMMUTABLEORDERBOOK_API Response
{
public:
	virtual ~Response() {}
	virtual bool FromJson(const TSharedPtr<FJsonValue>& JsonValue) = 0;
