...
#include "APIOperatorAllowlistContractStatus.h"
...
void APIOperatorAllowlistContractStatus::WriteJson(JsonWriter& Writer) const
{
...
bool APIOperatorAllowlistContractStatus::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
