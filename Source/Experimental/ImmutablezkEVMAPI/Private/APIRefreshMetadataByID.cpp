...
void APIRefreshMetadataByID::WriteJson(JsonWriter& Writer) const
{
	...
	Writer->WriteIdentifierPrefix(TEXT("metadata_id")); WriteJsonValue(Writer, MetadataId);
	Writer->WriteObjectEnd();
}

bool APIRefreshMetadataByID::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
