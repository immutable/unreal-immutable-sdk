...
#include "APIVerificationRequest.h"
...
void APIVerificationRequest::WriteJson(JsonWriter& Writer) const
{
...
bool APIVerificationRequest::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
