...
UImtblPassportConnectPKCEAsyncAction *
UImtblPassportConnectPKCEAsyncAction::ConnectPKCE(UObject *WorldContextObject) {
  UImtblPassportConnectPKCEAsyncAction *PassportInitBlueprintNode =
      NewObject<UImtblPassportConnectPKCEAsyncAction>();
...
void UImtblPassportConnectPKCEAsyncAction::Activate() {
  ...
  GetSubsystem()->WhenReady(
      this, &UImtblPassportConnectPKCEAsyncAction::DoConnectPKCE);
}
...
void UImtblPassportConnectPKCEAsyncAction::DoConnectPKCE(
  ...
  // Run Connect
  Passport->ConnectPKCE(
      UImmutablePassport::FImtblPassportResponseDelegate::CreateUObject(
          this, &UImtblPassportConnectPKCEAsyncAction::OnConnectPKCE));
#endif
}

void UImtblPassportConnectPKCEAsyncAction::OnConnectPKCE(
