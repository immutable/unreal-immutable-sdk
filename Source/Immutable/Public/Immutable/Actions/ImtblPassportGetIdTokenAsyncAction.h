 ...
 */
UCLASS()
class IMMUTABLE_API UImtblPassportGetIdTokenAsyncAction
    : public UImtblBlueprintAsyncAction {
  GENERATED_BODY()

  DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FPassportGetIdTokenOutputPin,
...
public:
  UFUNCTION(BlueprintCallable,
            ...
            Category = "Immutable")
  static UImtblPassportGetIdTokenAsyncAction *
  GetIdToken(UObject *WorldContextObject);
