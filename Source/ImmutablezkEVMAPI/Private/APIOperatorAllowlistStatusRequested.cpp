...
void APIOperatorAllowlistStatusRequested::WriteJson(JsonWriter& Writer) const
{
...
bool APIOperatorAllowlistStatusRequested::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
