...
void APIRefreshCollectionMetadataRequest::WriteJson(JsonWriter& Writer) const
{
...
bool APIRefreshCollectionMetadataRequest::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
