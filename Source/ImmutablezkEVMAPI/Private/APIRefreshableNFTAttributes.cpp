...
#include "APIRefreshableNFTAttributes.h"
...
void APIRefreshableNFTAttributes::WriteJson(JsonWriter& Writer) const
{
...
bool APIRefreshableNFTAttributes::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
