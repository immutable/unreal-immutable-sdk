...
struct IMMUTABLEZKEVMAPI_API HttpRetryManager
	: public FManager
...
struct IMMUTABLEZKEVMAPI_API HttpRetryParams
{
	HttpRetryParams(
...
class IMMUTABLEZKEVMAPI_API Model
{
public:
	virtual ~Model() {}
...
class IMMUTABLEZKEVMAPI_API Request
{
public:
	virtual ~Request() {}
...
class IMMUTABLEZKEVMAPI_API Response
{
public:
	virtual ~Response() {}
	virtual bool FromJson(const TSharedPtr<FJsonValue>& JsonValue) = 0;
